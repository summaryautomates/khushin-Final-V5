        ...
        <CardContent className="p-0 h-full flex flex-col">
          ...
          >
            ...
            <Link href={`/product/${product.id}`} className="block group">
              <motion.h3 
                className="font-medium text-base tracking-wide text-white text-center line-clamp-2 h-[2.5rem] transition-colors duration-200 group-hover:text-primary/90"
            ...
            <p className="text-sm leading-relaxed text-zinc-300 tracking-wide text-center line-clamp-2 h-[2.5rem] opacity-80">
              {product.description}
            </p>
            ...
            <div className="pt-4 mt-auto">
              ...
              >
                <Button 
                  variant="default"
                  size="default"
                  className="w-full bg-primary hover:bg-primary/90 text-black font-bold shadow-md transition-all duration-300 py-4 sm:py-5 text-sm sm:text-base rounded-lg relative overflow-hidden"
