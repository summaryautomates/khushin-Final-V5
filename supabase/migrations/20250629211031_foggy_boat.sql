/*
  # Database Schema Setup for KHUSH.IN E-commerce Platform
  
  1. New Tables
    - `users` - User accounts and authentication
    - `products` - Product catalog with details
    - `orders` - Customer orders with shipping and tracking
  ...
  3. Sample Data
    - Initial product catalog with luxury lighters and flasks
*/
...
-- Create products table with features column
