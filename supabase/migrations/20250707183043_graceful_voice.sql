/*
  # KHUSH.IN E-commerce Platform Schema
...
-- Create security policies with unique names
-- Check if policies exist before creating them
DO $$
BEGIN
  -- Users policies
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'khushin_users_read_own') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'khushin_users_update_own') THEN
  ...
  -- Products policies
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'khushin_products_read_all') THEN
  ...
  -- Orders policies
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'khushin_orders_read_own') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'khushin_orders_create_own') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'khushin_orders_update_own') THEN
  ...
  -- Cart items policies
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'khushin_cart_items_manage_own') THEN
